(function($) {
	...
	headerStyle();
	//Update Whatsapp Icon Style and Scroll to Top
	function whatsappIcon() {
		if($('.main-header').length){
			var windowpos = $(window).scrollTop();
			var siteHeader = $('.main-header');
			var scrollLink = $('.whatsapp-button');
			if (windowpos >= 110) {
				siteHeader.addClass('fixed-header');
				scrollLink.addClass('open');
			} else {
	...
	whatsappIcon();
	//Update message Icon Style and Scroll to Top
	function messageIcon() {
		if($('.main-header').length){
			var windowpos = $(window).scrollTop();
			var siteHeader = $('.main-header');
			var scrollLink = $('.message-button');
			if (windowpos >= 110) {
				siteHeader.addClass('fixed-header');
				scrollLink.addClass('open');
			} else {
	...
	messageIcon();
	//Update notification Icon Style and Scroll to Top
	function notificationIcon() {
		if($('.main-header').length){
			var windowpos = $(window).scrollTop();
			var siteHeader = $('.main-header');
			var scrollLink = $('.notification-button');
			if (windowpos >= 110) {
				siteHeader.addClass('fixed-header');
				scrollLink.addClass('open');
			} else {
	...
	notificationIcon();
	//Update chatbot Icon Style and Scroll to Top
	function chatbotIcon() {
		if($('.main-header').length){
			var windowpos = $(window).scrollTop();
			var siteHeader = $('.main-header');
			var scrollLink = $('.chatbot-button');
			if (windowpos >= 110) {
				siteHeader.addClass('fixed-header');
				scrollLink.addClass('open');
			} else {
	...
	if ($('.multiple-item-carousel').length) {
		$('.multiple-item-carousel').owlCarousel({
			loop:true,
			margin:30,
			nav:false,
			smartSpeed: 500,
