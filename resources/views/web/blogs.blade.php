...
<section class="page-title centred" style="background-image: url({{asset('web-assets/images/background/cover-blog.jpg')}});">
    <div class="auto-container">
        <div class="content-box clearfix">
            <h1>Our Blogs</h1>
            <div class="blog-sidebar blog-category">
            <div class="sidebar-widget category-widget blogs-list">
                        <div class="widget-title">
                            <h4>Explore Our Blogs By Categories</h4>
                        </div>
                        <div class="widget-content">
                            <ul class="category-list blog-list clearfix">
