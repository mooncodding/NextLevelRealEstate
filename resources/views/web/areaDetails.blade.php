...
@section('content')
<!--Page Title-->
{{-- <section class="area-detailbanner" style="background-image: url({{asset('web-assets/images/resource/downtown-banner.jpg')}});">
   <div class="overlay3">
                    ...
                    <div class="col-md-8">
                        <div class="content-box text-left area-bannercontent">
                            <h2>Explore Properties for Sale
                                <br class="head-area">in Down Town Dubai </h2>
                           <p>Emaar's flagship mega-development, Downtown Dubai occupies two of the
                            most prestigious square kilometres in Dubai. Flanked on either side by
                            Sheikh Zayed Road and Financial Centre Road, this dynamic city hub has
                            catalysed the economy & cemented Dubai’s reputation as a true global icon</p>
...
<section class="banner-style-two centred">
    <div class="banner-carousel owl-theme owl-carousel owl-nav-none">
        <div class="slide-item area-items">
            <div class="image-layer" style="background-image:url({{asset('web-assets/images/resource/areabanner1.jpg')}}) ">
            </div>

            <div class="auto-container area-tick">
                <div class="row">
                    <div class="col-md-8">
                        <div class="content-box text-left area-bannercontent">
                            <h2>Explore Properties for Sale
            ...
            <div class="slide-item area-items">
                <div class="image-layer"
                    style="background-image:url({{asset('web-assets/images/resource/areabanner2.jpg')}})">
                </div>
                <div class="auto-container area-tick">
                    <div class="row">
                        <div class="col-md-8">
            ...
            <div class="slide-item area-items">
                <div class="image-layer"
                    style="background-image:url({{asset('web-assets/images/resource/areabanner3.jpg')}})">
                </div>
                <div class="auto-container area-tick">
                    <div class="row">
                        <div class="col-md-8">
...
<section class="section about-property choose-area">
    <div class="row">
        ...
        <div class="col-lg-5 property-content why-area">
            <h2>Why Choose<br>Downtown Dubai?</h2>
            <hr class="areaproperty-line">
