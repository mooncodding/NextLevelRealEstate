                ...
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 left-side">
                        <div class="sec-title">
                            ...
                            <h2>Build Career With <br />NEXT LEVEL REAL ESTATE</h2>
                            ...
                            <p>Allow them to feel independent safe and secure all while having fun! Our amenities include.</p>
                        </div>
                    </div>
                        ...
                        <ul class="accordion-box">
                            <li class="accordion block active-block">
                                <div class="acc-btn active">
                                    ...
                                    <h5>Commercial Real Estate Agent</h5>
                                </div>
                                <div class="acc-content current">
                                    <div class="content-box">
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing eumod tempor incididunt labore dolore magna aliqua enim minim veniam. quis nostrud exercitation.</p>
                                        <h4>Responsibilities:</h4>
                                        <p>Consectetur adipisicing eumod tempor incididunt labore dolore magna aliqua enim.</p>
                                        ...
                                        <a href="career.html" class="theme-btn btn-one">Apply Now</a>
                                    </div>
                                </div>
                            </li>
                            <li class="accordion block">
                                <div class="acc-btn">
                                    <div class="icon-outer"><i class="fas fa-angle-down"></i></div>
                                    <h5>Real Estate Managing Broker</h5>
                                </div>
                            ...
                            <li class="accordion block">
                                 <div class="acc-btn">
                                    <div class="icon-outer"><i class="fas fa-angle-down"></i></div>
                                    <h5>Corporate Real Estate Manager</h5>
                                </div>
                                <div class="acc-content">
                                    <div class="content-box">
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing eumod tempor incididunt labore dolore magna aliqua enim minim veniam. quis nostrud exercitation.</p>
                            ...
                            <li class="accordion block">
                                 <div class="acc-btn">
                                    <div class="icon-outer"><i class="fas fa-angle-down"></i></div>
                                    <h5>Corporate Real Estate Agent</h5>
                                </div>
                                <div class="acc-content">
                                    <div class="content-box">
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing eumod tempor incididunt labore dolore magna aliqua enim minim veniam. quis nostrud exercitation.</p>
                ...
                <div class="row align-items-center clearfix">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image-box wow fadeInRight animated" data-wow-delay="00ms" data-wow-duration="3000ms">
                            <figure class="image"><img src="{{asset('web-assets/images/resource/careers-banner.webp')}}" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
