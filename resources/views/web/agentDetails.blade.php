...
@section('content')
        ...
        <!--Page Title-->
        <section class="page-title centred" style="background-image: url({{asset('web-assets/images/background/agent-details-banner.jpg')}});">
                            ...
                            <div class="content-box">
                                <div class="upper clearfix">
                                    ...
                                    <ul class="social-list pull-right clearfix">
                                        ...
                                        <li><a href="agents-details.html"><i class="fab fa-whatsapp"></i></a></li>
                                    </ul>
                                </div>
                                <div class="text">
                                                        ...
                                                        <div class="price-box clearfix">
                                                            ...
                                                            <div class="author-box pull-right">
                                                                <figure class="author-thumb"> 
                                                                    <img src="{{asset('web-assets/images/feature/author-2.jpg')}}" alt="">
