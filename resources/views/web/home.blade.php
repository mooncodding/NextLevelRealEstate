...
<section class="feature-section sec-pad ">
    <div class="auto-container">
        ...
        <div class="category-btn text-center mt-5">
            <a href="" class="theme-btn btn-one">View All Listing &nbsp; &nbsp;<i aria-hidden="true"
                        ...
                        <div class="image-box responsive" style="background-image: url({{asset('web-assets/images/resource/deals-1.webp')}}); height:600px;
                            ...
                            <div class="img-box responsive">
                                <div class="img-card text-left">
                                    ...
                                    <p>Here, you get to know how much supply is coming into each area and how much
                                        housing is in demand in that particular area, along with the total number of
                                        housing units.</p>
                                    <div class="btn-box pt-2 pl-3 pb-4">
                                        <a href="" class="theme-btn btn-one">View Appartments &nbsp; &nbsp;<i
                            ...
                            <div class="img-box responsive">
                                <div class="img-card text-left">
                                    ...
                                    <p>Here, you get to know how much supply is coming into each area and how much
                                        ...
                                        housing units.</p>
                                    <div class="btn-box pt-2 pl-3 pb-4">
                                        <a href="" class="theme-btn btn-one">View Vilas &nbsp; &nbsp;<i
                                                aria-hidden="true" class="fas fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="img-box responsive">
                                <div class="img-card text-left">
                                    ...
                                    <p>Here, you get to know how much supply is coming into each area and how much
                                        ...
                                        housing units.</p>
                                    <div class="btn-box pt-2 pl-3 pb-4">
                                        <a href="" class="theme-btn btn-one">View Town Houses &nbsp; &nbsp;<i
                                                aria-hidden="true" class="fas fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
