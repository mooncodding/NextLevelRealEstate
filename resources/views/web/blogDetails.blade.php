...
@section('content')
        <!--Page Title-->
        <section class="page-title centred" style="background-image: url({{asset('web-assets/images/background/page-title-5.jpg')}});">
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="blog-details-content">
                            <div class="news-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="{{asset('web-assets/images/news/news-21.jpg')}}" alt=""></figure>
                                ...
                                <div class="comment-box">
                                    <div class="comment">
                                        <figure class="thumb-box">
                                            <img src="{{asset('web-assets/images/news/comment-1.jpg')}}" alt="">
                                        </figure>
                                    ...
                                    <div class="comment replay-comment">
                                        <figure class="thumb-box">
                                            <img src="{{asset('web-assets/images/news/comment-2.jpg')}}" alt="">
                                        </figure>
                                        <div class="comment-inner">
                                            <div class="comment-info clearfix">
                                    ...
                                    <div class="comment">
                                        <figure class="thumb-box">
                                            <img src="{{asset('web-assets/images/news/comment-3.jpg')}}" alt="">
                                        </figure>
                                        <div class="comment-inner">
                                            <div class="comment-info clearfix">
