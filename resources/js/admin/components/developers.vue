<template>
  <v-app>
    <div class="content-wrapper">
      <div v-if="is('Super Admin') || can('developers')">
        <!-- Content Header (Page header) -->
        <div class="content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-6">
                <h1 class="m-0 text-dark">{{ $t("message.DEVELOPERS") }}</h1>
              </div>
              <!-- /.col -->
              <div class="col-6">
                <button class="btn btn-success float-right" @click="addDeveloper" v-if="(is('Super Admin') || can('create_developer'))">
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body table-responsive p-0">
                    <v-data-table
                      :headers="headers"
                      :items="developers.data ? developers.data : developers"
                      :server-items-length="developers.total"
                      class="elevation-1"
                      :loading="loading"
                    ...
                    >
                      <template v-slot:item.actions="{ item }">
                        ...
                        <v-icon
                          ...
                          v-if="(is('Super Admin') || can('edit_developer'))"
                        >
                          mdi-pencil
                        </v-icon>
                        ...
                        <v-icon
                          ...
                          class="delete-icon"
                          small
                          @click="deleteDeveloper(item.id)"
                          v-if="(is('Super Admin') || can('delete_developer'))"
                        >
                          mdi-delete
                        </v-icon>
                      </template>
        ...
        <!-- /.content -->
        <addEditDeveloperModal></addEditDeveloperModal>
        <viewDeveloperModal :developerData="developerInfo"></viewDeveloperModal>
      </div>
...
<script>
import addEditDeveloperModal from "./modals/addEditDeveloperModal.vue";
import viewDeveloperModal from "./modals/viewDeveloperModal.vue";
export default {
  data() {
    return {
      form: new form(),
      ...
      headers: [
        ...
        { text: this.$t("message.PHONE_NUMBER"), value: "phone_number" },
  ...
  methods: {
    getResults(page = 1, rows = 10, sortBy = null, sortDesc = null) {
      if (this.is('Super Admin') || this.can('developers')) {
        this.$Progress.start();
        this.loading = true;
        this.curpage = page;
    ...
    deleteDeveloper(id) {
      if (this.is('Super Admin') || this.can('delete_developer')) {
        swal
          .fire({
    ...
    addDeveloper() {
      if (this.is('Super Admin') || this.can('create_developer')) {
        $("#addEditDeveloperModal").modal("show");
      }else{
        toast.fire({
          icon: "error",
          title: this.$t("message.UNAUTHORIZED")
    ...
    editDeveloper(developer) {
      if (this.is('Super Admin') || this.can('edit_developer')) {
        ...
        $("#addEditDeveloperModal").modal("show", developer);
      }else{
        toast.fire({
          icon: "error",
          title: this.$t("message.UNAUTHORIZED")
    ...
    viewDeveloper(developer) {
      this.developerInfo = developer;
      $("#viewDeveloperModal").modal("show", developer);
    },
  },
  created() {
    Fire.$on("reloadDevelopers", () => {
